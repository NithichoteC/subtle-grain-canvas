...
export function TrustBar() {
  ...
  return (
    <div className="w-full bg-[#171717] border-t border-white/5 py-8 overflow-hidden relative">
      ...
      <div className="flex">
        ...
        <motion.div
          ...
          animate={{
            x: [0, -100 * badges.length - 64 * (badges.length - 1)]
          }}
          transition={{
            x: {
              repeat: Infinity,
        ...
        <motion.div
          className="flex items-center space-x-16 whitespace-nowrap ml-16"
          animate={{
            x: [0, -100 * badges.length - 64 * (badges.length - 1)]
          }}
          transition={{
